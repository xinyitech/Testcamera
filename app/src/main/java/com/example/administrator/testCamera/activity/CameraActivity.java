...
import com.example.administrator.testCamera.utils.CompressHelper;
import com.example.administrator.testCamera.utils.FileUtil;
import com.example.administrator.testCamera.utils.PictureUtils;
        ...
        if (requestCode == GET_PHOTO && resultCode == Activity.RESULT_OK && data != null) {
            ...
            if (selectedImage != null) {
                try {
                    ...
                    Log.e("---压缩前----", String.format("Size : %s", getReadableFileSize(oldFile.length())));
